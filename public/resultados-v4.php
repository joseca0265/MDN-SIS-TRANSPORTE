...
.marker2 {
background-image: url('iconos/marcador1.png');
background-size: cover;
width: 50px;
height: 50px;
border-radius: 50%;
...
style: 'mapbox://styles/jcarlosmdn/cknq8hz090soe17mnzo78idy9', // style URL
center: [<?php echo $porciones[1].", ".$porciones[0]; ?>], // starting position [lng, lat]
zoom:13,
...
container: 'map', // container ID
style: 'mapbox://styles/jcarlosmdn/cknq8hz090soe17mnzo78idy9', // style URL
center: [-75.33244572571617, -9.577903389286705], // starting position [lng, lat]
zoom:5,
maxzoom:5,
maxBounds: bounds
});
