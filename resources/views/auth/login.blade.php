        ...
        <div class="hero-body">
            <div class="container has-text-centered">
                <div class="column is-4 is-offset-4">
                    ...
                    <div class="box" style="background:#d9d9d9">
                        <figure class="avatar" style="padding: 0">
                            <img style="width: 130px; height:124px; background:#7f7f7f39; border-color:#d9d9d9;border-width:3px;border-style:solid" src="{{url("/img/logo-cuadrado.jpg") }}">
                        </figure>
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            <button type="submit" class="button is-block is-info is-large is-fullwidth" style="background:#F4A71D; color:#000">Ingresar
                            </button>
                        </form>
                    </div>
